...
import com.trigerz.dailyfacilitator.core.drink.usecase.CreateDrinkImpl;
import com.trigerz.dailyfacilitator.core.drink.usecase.GetAllDrinks;
import com.trigerz.dailyfacilitator.infrastructure.drink.entrypoints.rest.DrinkApiMapper;
...
public class DrinkConfiguration {
	...
	public CreateDrink createCreateDrink() {
		return new CreateDrinkImpl(drinkRepositoryPortAdapter);
	}
